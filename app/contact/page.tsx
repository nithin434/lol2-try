      ...
      <main className="py-20 relative">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Business Hours */}
            <Card className="bg-white/5 backdrop-blur-sm border-white/10 text-center relative overflow-hidden mb-8">
            ...
            {/* Discord Community */}
            <Card className="bg-gradient-to-r from-indigo-500/20 to-purple-600/20 backdrop-blur-sm border-indigo-500/30 text-center relative overflow-hidden">
              <CardContent className="p-8">
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/10 to-purple-600/10"></div>
                <div className="relative">
                  <svg className="w-12 h-12 text-indigo-400 mx-auto mb-4" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                    Connect with other professionals, get instant support, and stay updated with the latest features and tips.
                  </p>
                  <a 
                    href="https://discord.gg/qNHAJzYQ" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white px-8 py-3 rounded-lg transition-colors font-semibold"
                  >
